...
export default function Page() {
  ...
  return (
    <main className="flex-grow w-full bg-[#fbf9f4]">
      ...
      {/* ModeCards Grid */}
      <section className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 mb-20 relative z-30 pt-12 sm:pt-16 bg-[#fbf9f4]">
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 relative z-30 pb-16 sm:pb-20">
        <div className="flex flex-col md:flex-row bg-[var(--color-primary-container)] text-[var(--color-on-primary)] shadow-xl">
          <div className="w-full md:w-1/2 overflow-hidden">
            <img
              className="w-full h-[280px] sm:h-[360px] md:h-full object-cover grayscale hover:grayscale-0 transition-all duration-700"
          ...
          <div className="w-full md:w-1/2 p-8 sm:p-12 md:p-20 flex flex-col justify-center">
            ...
            <h2 className="font-headline text-3xl sm:text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Preserving the Silence of the Valley
            </h2>
            <p className="font-body text-base sm:text-lg opacity-80 mb-8 sm:mb-10 leading-relaxed italic">
            ...
            <div>
              <button
                ...
                className="inline-flex bg-[var(--color-secondary)] text-[var(--color-on-secondary)] px-6 sm:px-8 py-3 sm:py-4 font-label text-xs uppercase tracking-widest hover:opacity-90 transition-opacity"
              >
                Read the Protocol
              </button>
            </div>
      ...
      {openProtocol ? (
        ...
        >
          <div className="w-full max-w-5xl bg-[var(--color-surface-container-lowest)] border border-[var(--color-outline-variant)] shadow-2xl max-h-[85vh] overflow-y-auto">
            ...
            <div className="p-6 md:p-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
